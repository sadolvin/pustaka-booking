...
class Autentifikasi extends CI_Controller { 
    public function index() { 
        ...
        $this->form_validation->set_rules(
            'email', 'Alamat Email', 'required|trim|valid_email', [ 
  ...
  public function registrasi()
  {
      ...
      if ($this->form_validation->run() == false) {
          ...
          $data = ['nama' => htmlspecialchars($this->input->post('nama', true)), 'email' => htmlspecialchars($email), 'image' => 'default.jpg', 'password' => md5 ($this->input->post('password1')), 'role_id' => 2, 'is_active' => 0, 'tanggal_input' => $now];
